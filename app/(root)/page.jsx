...
import banner_min from '../../public/images/banner-tiny.png'  
      ...
      <section ref={targetRef} className="h-[102vh] bg-[#9DA1A4] relative">
        <div className="flex flex-col h-full justify-between relative overflow-hidden">
          <MotionImage
            ...
            width={1920}
            height={1080}
            className="h-full w-auto absolute left-1/2 -translate-x-1/2 object-cover pointer-events-none select-none z-0 will-change: transform;"
          />
          <Header />
